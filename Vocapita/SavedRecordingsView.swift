...
struct SavedRecordingsView: View {
    ...
    private var emptyStateView: some View {
        VStack(spacing: 24) {
            ...
            Text("Your saved voice recordings will appear here. Create recordings from the main screen to get started.")
                .font(.body)
...
struct SavedRecordingRowView: View {
